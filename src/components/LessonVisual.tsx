...
const cards: Record<number, { title: string; note: string; items: { title: string; detail?: string; tone?: Tone }[] }> = {
  ...
  6: { title: 'Ce qui était prévu ≠ qui l’a vraiment fait', note: 'Le plan dit qui devait faire chaque tâche ; le journal dit qui l’a faite. Certaines tâches prévues pour Youssef ont été réalisées par Meriem. Au jury, citez le journal, pas le plan.', items: [
    { title: 'Prévu · Youssef', detail: 'Le moteur, les écrans et les scripts d’évaluation' }, { title: 'Prévu · Meriem', detail: 'Les documents de test, les 60 questions, les contrôles qualité et le mémoire', tone: 'green' }, { title: 'Réalisé · Meriem aussi', detail: 'Plusieurs tâches du moteur, et le remplacement de Gradio par les pages serveur', tone: 'amber' }] },
  ...
  13: { title: 'La démo : six gestes vérifiables', note: 'Les figures font partie de la version principale du code. Avant la démo, vérifiez qu’elles sont bien sur le site déployé et que les documents avec figures sont déjà synchronisés.', items: [
